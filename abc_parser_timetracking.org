...
| IDE Features | Warn about incomplete line-overlay markers          |            1.5 |           1.5 |   0.0 |       1.5 |     0.00 |
| Scanner      | Implement redefinable symbols (U:)                  |            3.0 |           3.0 |   0.0 |       3.0 |     0.00 |
| Scanner      | Implement macros (m:)                               |            3.5 |           3.5 |   0.0 |       3.5 |     0.00 |
| Scanner      | Implement decoration (I:)                           |            2.0 |           2.0 |   0.0 |       2.0 |     0.00 |
| Scanner      | Implement history and free text (H:)                |            2.5 |           2.5 |   0.0 |       2.5 |     0.00 |
| Scanner      | Implement begintext/endtext                         |            1.5 |           1.5 |   0.0 |       1.5 |     0.00 |
...
|--------------+-----------------------------------------------------+----------------+---------------+-------+-----------+----------|
| TOTAL        |                                                     |           30.0 |          30.0 |   1.0 |      29.0 |    30.00 |
