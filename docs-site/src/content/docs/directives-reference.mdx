...
description: Comprehensive reference of ABC notation directives
---

This page provides a comprehensive reference of stylsheet directives of the ABCJS rendering library.

ABCLS provides autocomplete for these directives. Typing `%%` triggers autocomplete for directive names, and typing a space after the directive name triggers completions for the available parameter values.

For directives specific to the abcls language server, see [abcls Directives](/user-guide/abcls-directives/).
