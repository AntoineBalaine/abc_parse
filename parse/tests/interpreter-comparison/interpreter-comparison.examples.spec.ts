...
import { parseWithYourParser, runComparison, createSimpleTune } from "./test-helpers";
...
CDEF|`;
        ...
        expect(yourTune.systems).to.have.length(1);
        ...
        expect(yourTune.systems.length).to.equal(abcjsTune.lines.length);
...
CDEF|`;
        ...
        const yourLine = parseWithYourParser(input).tunes[0].systems[0];
...
CDEF|`;
    ...
    it("KNOWN ISSUE: abcjs applies broken rhythm across barline", () => {
      ...
      const ourLine = ourResult.tunes[0].systems[0] as any;
