...
import { scanInfoLine2 } from "../parsers/infoLines/scanInfoLine";
import { Ctx, TT } from "../parsers/scan";
import { info_line } from "../parsers/scan";
...
describe("scanInfoLine2 - Unified Info Line Scanner", () => {
  ...
  describe("Round-trip testing with generated data", () => {
    ...
    // Note: Tune body pitch syntax (^c, _b, =f) is NOT supported in key signatures.
    // Key signatures should use absolute pitch syntax (F#, Bb, C#m) instead.
    // Tests for K:^c_B, K:^G, and K:DMix_B_e have been removed as that feature is not supported.
